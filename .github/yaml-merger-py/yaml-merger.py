...
## Define class to represent null values as 'null'
...
# Set to preserve quotes as in original file
...
# Load file2
with open(sys.argv[2], "r", encoding="utf8") as file2:
    code2 = yaml.load(file2)
