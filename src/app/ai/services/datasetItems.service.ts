...
export class DatasetItemService {
  ...
  async createDatasetItem(datasetId: any, input: any, output: any): Promise<any> {
    const token = localStorage.getItem('access_token')
    const url = `${API_URL}/api/dataset-items`
    const headers = {
  ...
  async uploadCsv(datasetId: string, file: File): Promise<any> {
    const token = localStorage.getItem('access_token')
    const url = `${API_URL}/api/dataset-items/upload/${datasetId}`
  ...
  async getByDatasetId(datasetId: any): Promise<any> {
    const token = localStorage.getItem('access_token')
