...
@Component({
    templateUrl: './developer-executions.component.html',
    styleUrl: './developer-executions.component.scss',
    standalone: false
})
export class DeveloperExecutionsComponent implements OnInit {
  periods: any[]
  selectedPeriod: any
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle('FlowX.AI Observatory - Developer Agents')
    this.metaService.updateTag({
      name: 'description',
      content: 'Monitor developer agent executions.',
    })
